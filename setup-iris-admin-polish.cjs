...
const backupRoot = path.join(
  repoRoot,
  ".iris-backups",
  "admin-polish-" + startedAt.toISOString().replace(/[:.]/g, "-")
);
...
writeWebFile("src/components/system/system-status-bar.tsx", String.raw`
...
writeWebFile("src/components/admin/admin-dashboard-skeleton.tsx", String.raw`
...
writeWebFile("src/components/admin/admin-route-loading.tsx", String.raw`
...
writeWebFile("src/app/dashboard/loading.tsx", String.raw`
...
writeWebFile("src/components/admin/admin-shell.tsx", String.raw`
...
writeWebFile("src/components/admin/admin-sidebar.tsx", String.raw`
...
writeWebFile("src/components/admin/admin-topbar.tsx", String.raw`
    ...
    <div className="sticky top-0 z-30 px-4 pt-4 sm:px-6 lg:px-8">
      <header className="mx-auto flex min-h-16 w-full max-w-7xl items-center gap-3 rounded-[30px] border border-[#E0DDD6]/70 bg-white/[0.58] px-3 py-2 shadow-[0_16px_55px_rgba(17,17,17,0.055)] backdrop-blur-3xl dark:border-[#2A2A2A] dark:bg-[#1C1C1C]/[0.58] sm:px-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="truncate text-[13px] font-semibold text-[#111111] dark:text-[#FAF7F2] sm:mt-0.5">{activeItem?.title ?? "Admin IRÍS"}</p>
        </div>
        ...
        <form className="relative hidden w-56 items-center text-[#666666] md:flex lg:w-72" role="search" onSubmit={(event) => event.preventDefault()}>
          ...
          <input
            ...
            className="h-10 w-full rounded-full border border-[#E0DDD6]/70 bg-[#FAF7F2]/45 pl-10 pr-4 text-[13px] outline-none transition placeholder:text-[#8A8A8A] focus:border-[#006D4E]/45 focus:bg-white/70 focus:ring-4 focus:ring-[#006D4E]/10 dark:border-[#2A2A2A] dark:bg-[#111111]/45 dark:text-[#FAF7F2] dark:focus:bg-[#111111]/70"
          />
        </form>
...
writeWebFile("src/app/dashboard/page.tsx", String.raw`
